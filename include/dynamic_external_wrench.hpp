...
template <size_t DOF>
class DynamicExternalWrench : public barrett::systems::System {
    BARRETT_UNITS_TEMPLATE_TYPEDEFS(DOF);

  public:
    Input<jt_type> dynamicExternalTorqueIn;
  ...
  public:
    explicit DynamicExternalWrench(barrett::systems::ExecutionManager* em,
                            const std::string& sysName = "DynamicExternalWrench")
        : barrett::systems::System(sysName)
        , dynamicExternalTorqueIn(this)
        , jacobianIn(this)
  ...
  protected:
    ...
    virtual void operate() {
        tauExt = dynamicExternalTorqueIn.getValue();
  ...
  private:
    DISALLOW_COPY_AND_ASSIGN(DynamicExternalWrench);
};