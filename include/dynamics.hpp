...
#include "regressor_W.hpp"

template<size_t DOF>
class Dynamics : public barrett::systems::System {
...
public:
	explicit Dynamics(barrett::systems::ExecutionManager* em) :
...
protected:
	...
	virtual void operate() {
		...
		ThetaddotInput << 0.25 * tmp_theta_acc[0],
						  0.25 * tmp_theta_acc[1],
						  0.25 * tmp_theta_acc[2],
						  0.25 * tmp_theta_acc[3];

		W = calculate_W_eigen(ThetaInput, ThetadotInput, ThetaddotInput);
		beta = initialize_zeus_beta();
